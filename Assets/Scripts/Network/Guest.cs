...
public class Guest: Common
{
    ...
    void StartMatchmaking()
    {
        ...
        //matchmakingOptions.SetEnqueueQueryKey( "piootabouret" );
        ...
        Matchmaking.Enqueue2("piootabouret", matchmakingOptions ).OnComplete( MatchmakingEnqueueCallback );
    ...
    //    localAvatar.GetComponent<CustomAvatar>().GetAvatarState( out avatarState[0] );
